...
export const metadata: Metadata = {
  title: "About · Loop by Argilette Lab",
  description:
    "Loop is a multi-LLM vibe-coding platform built by Argilette Lab. Chat, edit, and preview web apps in the browser.",
};
  ...
  return (
    <main className="mx-auto min-h-screen max-w-3xl px-6 py-16">
      ...
      <p className="mt-4 text-lg text-muted-foreground">
        Loop is an AI coding workspace built by{" "}
      ...
      <section className="mt-16 space-y-4 text-sm text-muted-foreground">
        ...
        <p>
          Loop is our take on what a Replit successor should feel like when
      ...
      <section className="mt-16 rounded-xl border border-border bg-card p-6">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          The Loop codebase is MIT-licensed. Fork it, run it, modify it. Find us
          on GitHub.
        </p>
        <Link
